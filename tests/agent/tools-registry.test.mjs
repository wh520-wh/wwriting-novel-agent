...
// 钉住「四域注册并集 = 15 个生产工具」：拆分后任何域的注册脱落/误注册都会使本测试红。
...
test("四域注册并集 = 15 个生产工具", async (t) => {
  ...
  // 此处只钉「并集 = 15」；暴露顺序由 tests/agent/tools.test.mjs 的
  // definitions() deepEqual 契约（GENERAL 9 前 DEEP 6 后）钉住，不在此重复。
