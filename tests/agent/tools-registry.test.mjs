...
const EXPECTED = new Set([
  ...
  "shell", "read_skill", "count_text", "style_stats", "read_continuity",
...
test("四域注册并集 = 16 个生产工具", async (t) => {
  ...
  // 此处只钉「并集 = 16」；暴露顺序由 tests/agent/tools.test.mjs 的
  // definitions() deepEqual 契约（GENERAL 10 前 DEEP 6 后）钉住，不在此重复。
